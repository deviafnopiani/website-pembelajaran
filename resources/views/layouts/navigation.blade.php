@php
    $user = Auth::user();
    $dashboardRoute = $user ? ($user->role === 'admin' ? 'admin.dashboard' : 'user.dashboard') : null;
    $profileEditRoute = $user ? ($user->role === 'admin' ? 'admin.profile.edit' : 'user.profile.edit') : null;
@endphp
